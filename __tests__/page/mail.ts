...
export class MailPage {
  ...
  async send(recipient: string, subject?: string, content?: string, attachments?: Array<string>) {
    ...
    if (attachments) await this.page.setInputFiles(this.attachmentsSelector, attachments);
